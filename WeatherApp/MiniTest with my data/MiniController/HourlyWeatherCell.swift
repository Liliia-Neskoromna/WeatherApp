...
extension HourlyWeatherCell {
    func setupConstraints() {
        ...
        dt.leadingAnchor.constraint(equalTo: icon.trailingAnchor, constant: 16).isActive = true
        dt.trailingAnchor.constraint(equalTo: leadingAnchor, constant: 16).isActive = true
        
        // lastMessageLabel constraints
        temp.topAnchor.constraint(equalTo: dt.bottomAnchor).isActive = true
        temp.leadingAnchor.constraint(equalTo: icon.trailingAnchor, constant: 16).isActive = true
